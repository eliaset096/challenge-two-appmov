package com.mobileapps.reto2_appmov.util;
...
public class HTTPSWebUtilDomi {
    ...
    public String GETrequest(String songName) {
        try {
            URL page = new URL("https://api.spotify.com/v1/search?q="+songName+"&type=track");
